---
name: welcome
description: Greet the user when a new project starts. This mind was created from the "minds-rqlite-wip" inspiration, so the welcome introduces that inspiration and immediately starts the adaptation conversation.
---

# Welcome the user (inspiration: minds-rqlite-wip)

This mind was created from an inspiration -- a published snapshot of apps
another mind built:

- Title: minds-rqlite-wip
- Slug: `minds-rqlite-wip`
...
- Manifest: `inspiration-minds-rqlite-wip.md` (at the repo root)

Do ALL of the following in your FIRST response, in the same turn, without
waiting to be asked:

1. Open with a short CUSTOM welcome that names **minds-rqlite-wip** and gives the
   one-line description above. Do NOT use a generic "Welcome to Minds"
   greeting and do NOT offer a generic suggestions list.
2. Immediately read `inspiration-minds-rqlite-wip.md` at the repo root (reading the
